...
namespace AppStudio
{
    ...
    {
        private Guid APP_ID = new Guid("80c68464-4e03-4091-bac1-d8224480832d");
        public const string APP_NAME = "Mega Curioso";
        ...
        {
            TileServices.CreateFlipTile(@"Descubra, aprenda e explore", @"");
        }
        #endregion
    }
}
