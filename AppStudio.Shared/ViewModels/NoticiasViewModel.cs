...
{
    public class NoticiasViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("NoticiasDetail", item);
                        });
                }
        ...
        {
            return new NoticiasDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("NoticiasList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("NoticiasDetail");
        }
    }
}
